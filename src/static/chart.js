window.addEventListener("DOMContentLoaded", () => {
	...
	function setupChart(containerId, symbol, buttonIds, settings) {
		...
		ohlcDiv.style.cssText = 'position:absolute;top:50px;left:10px;background:#1a202c;color:#d1d4dc;padding:4px 8px;font-size:12px;pointer-events:none;z-index:10;';
