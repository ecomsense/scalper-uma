...
async def restart_server() -> JSONResponse:
    ...
    """
    try:
        subprocess.run("/usr/bin/systemctl restart uma-scalper", shell=True, check=True)
...
async def stop_server() -> JSONResponse:
    ...
    """
    try:
        subprocess.run("/usr/bin/systemctl stop uma-scalper", shell=True, check=True)
...
async def start_server() -> JSONResponse:
    ...
    """
    try:
        subprocess.run("/usr/bin/systemctl start uma-scalper", shell=True, check=True)
